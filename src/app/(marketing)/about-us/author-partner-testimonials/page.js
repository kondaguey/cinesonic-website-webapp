...
function ReviewCard({ data }) {
  return (
    <div className="w-full relative p-8 md:p-12 rounded-2xl bg-[#0a0a0a] border border-white/5 hover:border-[#d4af37]/20 transition-colors duration-500 group">
      ...
      {/* BODY - UNIFIED STYLING */}
      {/* - text-base md:text-lg: Readable size for both.
         - font-sans: Clean, modern font for both.
         - text-white/70: Standard contrast for both.
         - font-light: Elegant weight for both.
      */}
